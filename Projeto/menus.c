...
//MENU PRINCIPAL
void menu( Funcionarios *funcionarios) {
    ...
    switch (opcao) {
        ...
        case 2:
            ...
            break;
        case 3:
            menu_gestao_funcionarios( funcionarios );
            break;
        case 4:
            menu_gestao_tabelas();
            break;
        ...
        case 6:
            ...
            break;
        case 0:
            printf("A aplicaÃ§Ã£o foi terminada com sucesso");
            exit(0);
    }
}

//MENU FUNCIONARIOS
void menu_gestao_funcionarios( Funcionarios *funcionarios ) {
    ...
    switch (opcao) {
        case 1:
            verificacao_addFuncionarios( funcionarios );
            break;
        case 2:
            verificacao_editarFuncionarios( funcionarios );
            break;
        case 3:
...
void menu_gestao_tabelas() {
    ...
    do {
        printf("\n+ GESTÃO DAS TABELAS DE DESCONTOS PARA O IRS E SEGURANÃ‡A SOCIAL +\n");
